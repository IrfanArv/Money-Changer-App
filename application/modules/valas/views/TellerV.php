                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                                ...
                                                <div class="general-label">
                                                    <form class="form-horizontal" id="form_beli" role="form">
                                                        <div class="row">
...
<script type="text/javascript"> 
    ...
    $(document).ready(function() {
        table = $('#table').DataTable({ 
            ...
            "order": [], 
            "ajax": {
                "url": "<?php echo site_url('valas/teller/rate_listteller')?>",
                "type": "POST"
            },
    ...
    shortcut.add("alt+k", function() {
        ...
        $.ajax({
            url : "<?php echo site_url('valas/teller/add_transaksibeli');?>",
            type: "POST",
    ...
    shortcut.add("alt+p", function() {
        ...
        $.ajax({
            url:"<?php echo site_url('valas/teller/add_invoice/');?>",
    ...
    shortcut.add("alt+t", function() {
        ...
        $('.res').val('');
        $('#pencarian').focus();
        $( "#transaksi_beli_valid" ).load( "<?php echo site_url('valas/teller/hitung_sukses_beli_teller')?>" );
        $( "#total_acc_beli" ).load( "<?php echo site_url('valas/teller/jumlah_sukses_beli_teller')?>" );
        $( "#isiModalbelisukses" ).load( "<?php echo site_url('valas/teller/detail_sukses_beli_teller')?>" );
        $( "#transaksi_beli_gagal" ).load( "<?php echo site_url('valas/teller/hitung_gagal_beli_teller')?>" );
        $( "#total_tolak_beli" ).load( "<?php echo site_url('valas/teller/jumlah_tolak_beli_teller')?>" );
    }); 
    ...
    $(document).ready(function(){
        tabletransaksiju = $('#tableTransaksiJual').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('valas/teller/cart_beli');?>",
                "type": "POST"
                },
            "columnDefs": [
            {
    ...
    $(function(){
        $("#pencarian").autocomplete({
            ...
            source: function(request, response) { 
                ...
                jQuery.ajax({
                    url:      "<?php echo site_url('valas/teller/cari_harga');?>",
                    data: {
    ...
    {
        $.ajax({
            url : "<?= site_url('valas/backoffice/deleteitembeli')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data){
                reload_table();
    ...
    {
        $.ajax({
            url:"<?php echo site_url('valas/teller/riwayatransaksiteller/');?>",
            method:"POST",
            success:function(data){
    ...
    {
        $.ajax({
            url:"<?php echo site_url('valas/teller/detail_sukses_beli_teller/');?>",
            method:"POST",
            success:function(data){ 
                $('#modal_recap_beli_success').modal('show'); 
    ...
    {
        $.ajax({
            url:"<?php echo site_url('valas/teller/detail_tolak_beli_teller/');?>",
            method:"POST",
            success:function(data){
                $('#modal_recap_beli_success').modal('show'); 
    ...
    $(document).ready(function()
    {
            $.ajax({    
                type: "GET",
                "url": "<?php echo site_url('valas/teller/hitung_sukses_beli_teller')?>",
                dataType: "html",   
    ...
    $(document).ready(function() {
        ...
        $.ajax({    
            type: "GET",
            "url": "<?php echo site_url('valas/teller/jumlah_sukses_beli_teller')?>",
            dataType: "html",   
            success: function(response){                    
    ...
    $(document).ready(function() 
    {
        $.ajax({    
            type: "GET",
            "url": "<?php echo site_url('valas/teller/hitung_gagal_beli_teller')?>",
            dataType: "html",   
            success: function(response){                    
    ...
    $(document).ready(function()
    {
            $.ajax({    
                type: "GET",
                "url": "<?php echo site_url('valas/teller/jumlah_tolak_beli_teller')?>",
                dataType: "html",   
                success: function(response){                    
    ...
    {
        $.ajax({
            url:"<?php echo site_url('valas/teller/detailriwayat/')?>/"+ no_invoice,
            method:"POST",
            success:function(data){
