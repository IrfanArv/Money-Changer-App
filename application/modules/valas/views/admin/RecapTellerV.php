            ...
            <div class="page-title-box">
                <div class="float-right">
                     <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Recap Pembelian Teller</li>
                    </ol> 
                </div>
                
                <h4 class="page-title">Recap Pembelian Teller</h4>
            </div>
        </div>
    </div>
...
<script type="text/javascript"> 
    ...
    $(document).ready(function() {
        table = $('#table').DataTable({ 
            ...
            "order": [], 
            "ajax": {
                "url": "<?php echo site_url('valas/adminvalas/list_recap_teller')?>",
                "type": "POST"
            },
    ...
    $(document).ready(function() {
        table_gagal = $('#table_gagal').DataTable({ 
            ...
            "order": [], 
            "ajax": {
                "url": "<?php echo site_url('valas/adminvalas/list_recap_teller_gagal')?>",
                "type": "POST"
            },
    ...
    function fetch_data(start_date='', end_date=''){
     table = $('#table').DataTable({
        ...
        "order":[],
        "ajax":{
            "url": "<?php echo site_url('valas/adminvalas/DateRecapTellerSuccess')?>",
            type: "POST",
            data:{
    ...
    function fetch_data_gagal(start_date='', end_date=''){
     table_gagal = $('#table_gagal').DataTable({
        ...
        "order":[],
        "ajax":{
            "url": "<?php echo site_url('valas/adminvalas/DateRecapTellerGagal')?>",
            type: "POST",
            data:{
                start_date:start_date, end_date:end_date
            },
